...
const RetryModal: React.FC<Props> = ({ data, setShow, show }) => {
  return (
    <React.Fragment>
                ...
                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to invoke this action? This action
                      will create a new payment record and redirect you the
                      payment service to continue the payment process.
                    </p>
                  </div>
                </div>
              </div>
